...
describe('general tests', () => {
  ...
  it('should recognize ipv4 encapsulated in ipv6', async () => {
  ...
  it('should recognize private addresses', async () => {
  ...
  it('should recognize localhost addresses', async () => {
  ...
  it('should recognize special addresses', async () => {
